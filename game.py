...
class Game:
    def __init__(self, screen):
        ...
        blue_ghost = pygame.transform.scale(pygame.image.load("C:\\Users\\raybo\\Documents\\INF1007\\2024A_PR01_Enonce\\assets\\images\\blue.png"), GHOST_SIZE)
        orange_ghost = pygame.transform.scale(pygame.image.load("C:\\Users\\raybo\\Documents\\INF1007\\2024A_PR01_Enonce\\assets\\images\\orange.png"), GHOST_SIZE)
        pink_ghost = pygame.transform.scale(pygame.image.load("C:\\Users\\raybo\\Documents\\INF1007\\2024A_PR01_Enonce\\assets\\images\\pink.png"), GHOST_SIZE)
