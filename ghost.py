...
class Ghost:
    ...
    def change_direction(self):
        ...
        directions_ghost = [Direction.LEFT, Direction.RIGHT, Direction.UP, Direction.DOWN]
        # TODO: Mélanger aléatoirement les directions pour simuler un choix aléatoire avec `random.shuffle()`
        random.shuffle(directions_ghost)
        ...
        for direction in directions_ghost:
            next_x = self.pos[0] + direction[0]
            next_y = self.pos[1] + direction[1]
